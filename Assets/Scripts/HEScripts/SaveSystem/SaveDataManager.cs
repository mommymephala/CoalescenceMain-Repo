...
namespace HEScripts.SaveSystem
{
    ...
    public class SaveDataManager<TData> : Singleton<SaveDataManager<TData>>
    {
        ...
        {
            public TData GameData;
            public ObjectStateSavable ObjectStates;
        }

        // --------------------------------------------------------------------

        public IEnumerator Save(TData data)
        {
        ...
        public IEnumerator SaveSlot(int slot, TData data)
        {
        ...
        public TData LoadSlot(int slot)
        {
            Debug.Assert(slot < k_MaxSlots, "Slot index is higher than MaxSlots");
