...
namespace HEScripts.Pooling
{
    ...
    public class GameObjectPool : SingletonBehaviour<GameObjectPool>
    {
        ...
        {
            Debug.Assert(go, "The GameObject you are trying to get from the pool is null");
            ...
            Debug.Assert(go.GetComponent<PooledGameObject>(), "The GameObject you are trying to get from the pool doesn't have a PooledGameObject component", gameObject);
        }
