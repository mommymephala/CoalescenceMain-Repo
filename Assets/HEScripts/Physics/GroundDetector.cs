...
namespace HEScripts.Physics
{
    ...
    public class GroundDetector : MonoBehaviour
    {
        ...
        {
            if (UnityEngine.Physics.Raycast(new Ray(position + Vector3.up * m_OffsetUp, Vector3.down), out RaycastHit hitRC, m_Distance, m_GroundCheckLayerMask, QueryTriggerInteraction.Ignore))
            {
