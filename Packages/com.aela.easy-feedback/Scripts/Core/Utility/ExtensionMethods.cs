...
namespace AeLa.EasyFeedback.Utility
{
	internal static class ExtensionMethods
	{
		...
		public static void Scale(
			this Texture2D tex, float scale, FilterMode filterMode = FilterMode.Trilinear, bool updateMipMaps = false
		)
		{
			...
			// apply to texture
#if UNITY_2021_2_OR_NEWER // Resize made obsolete in 2021.2
